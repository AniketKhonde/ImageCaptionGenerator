...
base_model = InceptionV3(weights = 'Models\inception_v3_weights_tf_dim_ordering_tf_kernels.h5')
...
pickle_in = open("Models\wordtoix.pkl", "rb")
wordtoix = load(pickle_in)
pickle_in = open("Models\ixtoword.pkl", "rb")
...
def classify(file_path):
    ...
    #print(beam_3)
    label1.configure(foreground='#000', text = 'Caption 2: ' + beam_3)
    label1.pack(side = BOTTOM, expand = True)
    beam_5 = beam_search(image, 5)
    #print(beam_5)
    label2.configure(foreground='#000', text = 'Caption 3: ' + beam_5)
